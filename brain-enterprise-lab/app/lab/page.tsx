      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <motion.div initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }}
          ...
          <div className="glass-card p-6 relative overflow-hidden">
            ...
            <div className="relative flex items-start gap-5">
              ...
              <motion.button
                ...
                style={{
                  background: initializing ? 'rgba(139,92,246,0.3)' : `linear-gradient(135deg, ${agent.color}, ${agent.color}99)`,
          ...
          <AnimatePresence>
            {initialized && (
              <motion.div
                ...
                <div className="flex items-center gap-2 text-[12px] font-semibold mb-2" style={{ color: agent.color }}>
                  <Zap size={13} />
                  Agent {agent.name} initialized — ready to receive tasks
                </div>
                <div className="font-code text-[11px] space-y-1" style={{ color: '#475569' }}>
                  <div><span style={{ color: '#8b5cf6' }}>role:</span> <span style={{ color: '#10b981' }}>"{agent.role}"</span></div>
                  <div><span style={{ color: '#8b5cf6' }}>trust_level:</span> <span style={{ color: '#f59e0b' }}>{agent.trustLevel}</span></div>
                  <div><span style={{ color: '#8b5cf6' }}>hierarchy_level:</span> <span style={{ color: '#f59e0b' }}>{agent.hierarchyLevel}</span></div>
                  <div><span style={{ color: '#8b5cf6' }}>status:</span> <span style={{ color: '#10b981' }}>"ready"</span></div>
                  <div><span style={{ color: '#8b5cf6' }}>tools_loaded:</span> <span style={{ color: '#60a5fa' }}>[{agent.tools.map(t => `"${t}"`).join(', ')}]</span></div>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="glass-card p-4">
              <div className="text-[11px] uppercase tracking-wider text-[#334155] mb-3 font-semibold flex items-center gap-2">
                <Brain size={11} style={{ color: '#8b5cf6' }} /> Decision Criteria
              </div>
              <div className="space-y-2">
            ...
            <div className="glass-card p-4">
              <div className="text-[11px] uppercase tracking-wider text-[#334155] mb-3 font-semibold flex items-center gap-2">
                <Cpu size={11} style={{ color: '#3b82f6' }} /> Tools & Integrations
              </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              { label: 'Total Messages', value: agent.totalMessages, color: '#3b82f6' },
            ].map(stat => (
