        ...
        <div className="card" style={{ padding: 22 }}>
          ...
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={BUDGET_ALLOCATIONS} layout="vertical" margin={{ top: 4, right: 12, bottom: 0, left: 0 }} barSize={12}>
              ...
              <Bar dataKey="allocated" name="Allocated" fill="rgba(139,92,246,0.18)" radius={[0, 3, 3, 0]} />
            ...
            {ids.map(to => {
              ...
              return (
                <div key={`${from}-${to}`} style={{
                  aspectRatio: '1.4 / 1',
                  background: from === to ? 'var(--surface-2)' : n === 0 ? 'rgba(255,255,255,0.02)' : `rgba(139,92,246,${0.08 + intensity * 0.5})`,
