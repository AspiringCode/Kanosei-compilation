...
const AGENT_COLORS: Record<AgentId, string> = {
  ceo: '#f59e0b', product: '#8b5cf6', engineering: '#3b82f6',
  hr: '#10b981', sales: '#22d3ee', marketing: '#ec4899', finance: '#f97316',
}
        ...
        <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }}
              ...
              {(['single', 'multi'] as const).map(m => (
                <button
                  ...
                  className={cn(
                    ...
                    mode === m
                      ? 'bg-[rgba(139,92,246,0.2)] text-[#a855f7] border border-[rgba(139,92,246,0.35)]'
                      : 'bg-[rgba(255,255,255,0.03)] text-[#475569] border border-[rgba(255,255,255,0.06)] hover:border-[rgba(139,92,246,0.2)]'
                  )}
                >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-lg p-3 text-[12px] resize-none outline-none focus:border-[rgba(139,92,246,0.4)] transition-colors"
              style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(139,92,246,0.15)', color: '#e2e8f0' }}
            />
            <div className="mt-1.5 flex flex-wrap gap-1">
              {EXAMPLE_GOALS.map(g => (
                <button key={g} onClick={() => setGoal(g)}
                  className="text-[10px] px-2 py-1 rounded text-[#475569] hover:text-[#8b5cf6] transition-colors"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg pl-8 pr-3 py-2.5 text-[13px] outline-none focus:border-[rgba(139,92,246,0.4)] transition-colors font-mono"
                style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(139,92,246,0.15)', color: '#e2e8f0' }}
              />
            </div>
          </div>
          ...
          <motion.button
            ...
            style={{ background: 'linear-gradient(135deg, #7c3aed, #2563eb)', boxShadow: '0 0 24px rgba(139,92,246,0.3)' }}
          >
            <Play size={14} />
            Launch Simulation
          </motion.button>
        ...
        <motion.div initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }}
          ...
          <div className="flex gap-3">
            {SIMULATIONS.map(sim => (
              ...
              >
                ...
                <div className="mt-2 h-1 rounded-full bg-[rgba(139,92,246,0.1)]">
                  <div className="h-full rounded-full transition-all"
                    style={{ width: `${sim.progress}%`, background: 'linear-gradient(90deg, #8b5cf6, #3b82f6)' }} />
                </div>
              </button>
            ))}
          </div>
          ...
          <div className="glass-card p-5">
            ...
            <div className="mb-4">
              ...
              <div className="h-2 rounded-full bg-[rgba(139,92,246,0.1)]">
                <motion.div
                  className="h-full rounded-full relative overflow-hidden"
                  style={{ width: `${activeSim.progress}%`, background: 'linear-gradient(90deg, #8b5cf6, #3b82f6)' }}
                  initial={{ width: 0 }}
          ...
          <div className="glass-card p-5">
            ...
            <div className="space-y-0 relative">
              <div className="absolute left-[18px] top-0 bottom-0 w-px bg-[rgba(139,92,246,0.12)]" />
