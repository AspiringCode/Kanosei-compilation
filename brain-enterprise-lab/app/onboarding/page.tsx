...
const AGENT_DEFS: AgentDef[] = [
  ...
  { id: 'product',     name: 'Vera',   role: 'Product Manager',    hex: '#A78BFA', cssVar: 'var(--agent-product)',     icon: <Package size={18} />,   desc: 'Roadmap, PRDs, user research, prioritization' },
    ...
    <div style={{ position: 'fixed', inset: 0, overflow: 'hidden', zIndex: 9999 }}>
      ...
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, padding: '22px 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', zIndex: 2 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ width: 26, height: 26, borderRadius: 7, background: 'rgba(139,92,246,0.15)', border: '1px solid rgba(139,92,246,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
